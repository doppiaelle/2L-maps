...
**Status:** Accepted, **partly superseded by [ADR-0029](0029-single-driver-wedge-and-subscription-first-freemium.md)**
**Date:** 2026-08-06
**Deciders:** Product owner
**Implements decisions:** D2, D10

> **What changed.** [ADR-0029](0029-single-driver-wedge-and-subscription-first-freemium.md)
> narrows the design centre to the independent or subcontracted single driver, keeps the 25-stop
> product ceiling, and replaces the hard-paywall decision with a bounded, advertising-free Free /
> Day pass / Pro ladder. This record remains the historical cost and scope analysis; ADR-0029 wins
> where they conflict.
